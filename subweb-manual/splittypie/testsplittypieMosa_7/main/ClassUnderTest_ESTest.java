...
public class ClassUnderTest_ESTest extends ClassUnderTest_ESTest_scaffolding {
   ...
   * Goal 6. main.ClassUnderTest.confirmConfirmationPage()V: Line 209
   ...
   * Goal 13. main.ClassUnderTest.settleUpEventDetailsContainerPage(Lcustom_classes/Id;)V: Line 367
   ...
   * Goal 4. main.ClassUnderTest.cancelConfirmationPage()V: Line 169
   ...
   * Goal 12. main.ClassUnderTest.viewDetailsAsEventDetailsContainerPage(Lcustom_classes/Participants;)V: Line 401
   */
  ...
  public void test7()  throws Throwable  {
      ...
      try { 
        classUnderTest0.addNewEventEventDetailsContainerPage(tripNames1);
         ...
         //
         // addNewEvent: trip Mirabilandia already exists
         //
         //verifyException("main.ClassUnderTest", e);
      }
      ...
      try { 
        classUnderTest0.goToHomePageAddEditEventContainerPage();
         ...
         //
         // goToHomePageAddEditEventContainerPage: expected po.event.pages.AddEditEventContainerPage, found EventDetailsContainerPage
         //
         //verifyException("main.ClassUnderTest", e);
      }
      ...
      try { 
        classUnderTest0.createNewEventNavbarHomePageContainerPage(tripNames3);
         ...
         //
         // createNewEventNavbar: tripName Mirabilandia already exists
         //
         //verifyException("main.ClassUnderTest", e);
      }
      ...
      // Undeclared exception!
      try { 
        classUnderTest0.addNewEventEventDetailsContainerPage(tripNames4);
      } catch(RuntimeException e) {
         //
      ...
      try { 
        classUnderTest0.goToAboutHomePageContainerPage();
         ...
         //
         // Expected condition failed: waiting for presence of element located by: By.xpath: //div[@id=\"navbar-right\"]//a[@title=\"About\"] (tried for 5 second(s) with 50 MILLISECONDS interval)
         //
